...
type Generator<T extends object = {}> = (request: ExtendedRequest, server: Server | null, derived: T) => MaybePromise<string>;
...
interface Options {
  ...
  context: Context;
  skip: (req: ExtendedRequest, key?: string) => boolean | Promise<boolean>;
